...
local originalTransparencies3 = {}
local RealFont = Font.new([[rbxasset://fonts/families/SourceSansPro.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal)
...
function Library:Window(options)
	...
	do -- Main Frame
		...
		table.insert(Library.ThemeObjects, GUI["ggg2"])
	...
	if options.Indicators then
		...
		function Library:UpdateIndicator(Target)
	...
	function GUI:CreateTab(options)
		...
		if options.HitParts == true then
			local HitPartsTab = Tab["4e"].Name
			...
			do
				-- StarterGui.MyLibrary.HitParts
				HitParts["2"] = Instance.new("Frame", GUI["2"]);
				HitParts["2"]["BorderSizePixel"] = 0;
				HitParts["2"]["BackgroundColor3"] = Color3.fromRGB(31, 31, 31);
				HitParts["2"]["AnchorPoint"] = Vector2.new(1, 0);
				HitParts["2"]["Size"] = UDim2.new(0, 233, 0, 298);
				HitParts["2"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["2"]["Position"] = UDim2.new(1, 243, 0, 0);
				HitParts["2"]["Name"] = [[HitParts]];

				-- StarterGui.MyLibrary.HitParts.UIStroke
				HitParts["3"] = Instance.new("UIStroke", HitParts["2"]);
				HitParts["3"]["Color"] = Color3.fromRGB(20, 20, 20);
				HitParts["3"]["LineJoinMode"] = Enum.LineJoinMode.Miter;

				-- StarterGui.MyLibrary.HitParts.Holder
				HitParts["4"] = Instance.new("Frame", HitParts["2"]);
				HitParts["4"]["BorderSizePixel"] = 0;
				HitParts["4"]["BackgroundColor3"] = Color3.fromRGB(21, 21, 21);
				HitParts["4"]["AnchorPoint"] = Vector2.new(1, 0);
				HitParts["4"]["BackgroundTransparency"] = 1;
				HitParts["4"]["Size"] = UDim2.new(1, 0, 1, -25);
				HitParts["4"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["4"]["Position"] = UDim2.new(1, 0, 0, 25);
				HitParts["4"]["Name"] = [[Holder]];

				-- StarterGui.MyLibrary.HitParts.Holder.R6BodyParts
				HitParts["38d"] = Instance.new("Frame", HitParts["4"]);
				HitParts["38d"]["BorderSizePixel"] = 0;
				HitParts["38d"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["38d"]["BackgroundTransparency"] = 1;
				HitParts["38d"]["Size"] = UDim2.new(0, 204, 0, 250);
				HitParts["38d"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["38d"]["Position"] = UDim2.new(0, 15, 0, 10);
				HitParts["38d"]["Name"] = [[R6BodyParts]];

				-- StarterGui.MyLibrary.HitParts.Holder.R6BodyParts.Head
				HitParts["3d9"] = Instance.new("Frame", HitParts["38d"]);
				HitParts["3d9"]["ZIndex"] = 2;
				HitParts["3d9"]["BorderSizePixel"] = 0;
				HitParts["3d9"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["3d9"]["AnchorPoint"] = Vector2.new(0.5, 0);
				HitParts["3d9"]["Size"] = UDim2.new(0, 50, 0, 50);
				HitParts["3d9"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["3d9"]["Position"] = UDim2.new(0.5, 0, 0, 17);
				HitParts["3d9"]["Name"] = [[Head]];

				-- StarterGui.MyLibrary.HitParts.Holder.R6BodyParts.Head.UIStroke
				HitParts["3a"] = Instance.new("UIStroke", HitParts["3d9"]);
				HitParts["3a"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.R6BodyParts.Head.TextButton
				HitParts["3b"] = Instance.new("TextButton", HitParts["3d9"]);
				HitParts["3b"]["BorderSizePixel"] = 0;
				HitParts["3b"]["TextTransparency"] = 1;
				HitParts["3b"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["3b"]["TextSize"] = 14;
				HitParts["3b"]["FontFace"] = RealFont
				HitParts["3b"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["3b"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["3b"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["3b"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.R6BodyParts.UpperTorso
				HitParts["3e"] = Instance.new("Frame", HitParts["38d"]);
				HitParts["3e"]["BorderSizePixel"] = 0;
				HitParts["3e"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["3e"]["AnchorPoint"] = Vector2.new(0.5, 0);
				HitParts["3e"]["Size"] = UDim2.new(0, 80, 0, 90);
				HitParts["3e"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["3e"]["Position"] = UDim2.new(0.5, 0, 0, 68);
				HitParts["3e"]["Name"] = [[Torso]];

				-- StarterGui.MyLibrary.HitParts.Holder.R6BodyParts.UpperTorso.UIStroke
				HitParts["3f"] = Instance.new("UIStroke", HitParts["3e"]);
				HitParts["3f"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.R6BodyParts.UpperTorso.TextButton
				HitParts["40"] = Instance.new("TextButton", HitParts["3e"]);
				HitParts["40"]["BorderSizePixel"] = 0;
				HitParts["40"]["TextTransparency"] = 1;
				HitParts["40"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["40"]["TextSize"] = 14;
				HitParts["40"]["FontFace"] = RealFont
				HitParts["40"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["40"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["40"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["40"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.R6BodyParts.LeftUpperLeg
				HitParts["41"] = Instance.new("Frame", HitParts["38d"]);
				HitParts["41"]["BorderSizePixel"] = 0;
				HitParts["41"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["41"]["AnchorPoint"] = Vector2.new(0.5, 0);
				HitParts["41"]["Size"] = UDim2.new(0, 39, 0, 85);
				HitParts["41"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["41"]["Position"] = UDim2.new(0, 82, 0, 160);
				HitParts["41"]["Name"] = [[Left Leg]];

				-- StarterGui.MyLibrary.HitParts.Holder.R6BodyParts.LeftUpperLeg.UIStroke
				HitParts["42"] = Instance.new("UIStroke", HitParts["41"]);
				HitParts["42"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.R6BodyParts.LeftUpperLeg.TextButton
				HitParts["43"] = Instance.new("TextButton", HitParts["41"]);
				HitParts["43"]["BorderSizePixel"] = 0;
				HitParts["43"]["TextTransparency"] = 1;
				HitParts["43"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["43"]["TextSize"] = 14;
				HitParts["43"]["FontFace"] = RealFont
				HitParts["43"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["43"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["43"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["43"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.R6BodyParts.RightUpperLeg
				HitParts["44"] = Instance.new("Frame", HitParts["38d"]);
				HitParts["44"]["BorderSizePixel"] = 0;
				HitParts["44"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["44"]["AnchorPoint"] = Vector2.new(0.5, 0);
				HitParts["44"]["Size"] = UDim2.new(0, 40, 0, 85);
				HitParts["44"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["44"]["Position"] = UDim2.new(0, 122, 0, 160);
				HitParts["44"]["Name"] = [[Right Leg]];

				-- StarterGui.MyLibrary.HitParts.Holder.R6BodyParts.RightUpperLeg.UIStroke
				HitParts["45"] = Instance.new("UIStroke", HitParts["44"]);
				HitParts["45"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.R6BodyParts.RightUpperLeg.TextButton
				HitParts["46"] = Instance.new("TextButton", HitParts["44"]);
				HitParts["46"]["BorderSizePixel"] = 0;
				HitParts["46"]["TextTransparency"] = 1;
				HitParts["46"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["46"]["TextSize"] = 14;
				HitParts["46"]["FontFace"] = RealFont
				HitParts["46"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["46"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["46"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["46"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.R6BodyParts.RightUpperArm
				HitParts["47"] = Instance.new("Frame", HitParts["38d"]);
				HitParts["47"]["BorderSizePixel"] = 0;
				HitParts["47"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["47"]["Size"] = UDim2.new(0, 40, 0, 89);
				HitParts["47"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["47"]["Position"] = UDim2.new(1, -61, 0, 68);
				HitParts["47"]["Name"] = [[Right Arm]];

				-- StarterGui.MyLibrary.HitParts.Holder.R6BodyParts.RightUpperArm.UIStroke
				HitParts["48"] = Instance.new("UIStroke", HitParts["47"]);
				HitParts["48"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.R6BodyParts.RightUpperArm.TextButton
				HitParts["49"] = Instance.new("TextButton", HitParts["47"]);
				HitParts["49"]["BorderSizePixel"] = 0;
				HitParts["49"]["TextTransparency"] = 1;
				HitParts["49"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["49"]["TextSize"] = 14;
				HitParts["49"]["FontFace"] = RealFont
				HitParts["49"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["49"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["49"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["49"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.R6BodyParts.LeftUpperArm
				HitParts["4a"] = Instance.new("Frame", HitParts["38d"]);
				HitParts["4a"]["BorderSizePixel"] = 0;
				HitParts["4a"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["4a"]["Size"] = UDim2.new(0, 40, 0, 89);
				HitParts["4a"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["4a"]["Position"] = UDim2.new(0, 21, 0, 68);
				HitParts["4a"]["Name"] = [[Left Arm]];

				-- StarterGui.MyLibrary.HitParts.Holder.R6BodyParts.LeftUpperArm.UIStroke
				HitParts["4b"] = Instance.new("UIStroke", HitParts["4a"]);
				HitParts["4b"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.R6BodyParts.LeftUpperArm.TextButton
				HitParts["4c"] = Instance.new("TextButton", HitParts["4a"]);
				HitParts["4c"]["BorderSizePixel"] = 0;
				HitParts["4c"]["TextTransparency"] = 1;
				HitParts["4c"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["4c"]["TextSize"] = 14;
				HitParts["4c"]["FontFace"] = RealFont
				HitParts["4c"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["4c"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["4c"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["4c"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder
				HitParts["5"] = Instance.new("Frame", HitParts["4"]);
				HitParts["5"]["BorderSizePixel"] = 0;
				HitParts["5"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["5"]["BackgroundTransparency"] = 1;
				HitParts["5"]["Size"] = UDim2.new(0, 204, 0, 250);
				HitParts["5"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["5"]["Position"] = UDim2.new(0, 15, 0, 10);
				HitParts["5"]["Name"] = [[R15BodyParts]];

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.Head
				HitParts["6"] = Instance.new("Frame", HitParts["5"]);
				HitParts["6"]["ZIndex"] = 2;
				HitParts["6"]["BorderSizePixel"] = 0;
				HitParts["6"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["6"]["AnchorPoint"] = Vector2.new(0.5, 0);
				HitParts["6"]["Size"] = UDim2.new(0, 50, 0, 50);
				HitParts["6"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["6"]["Position"] = UDim2.new(0.5, 0, 0, 17);
				HitParts["6"]["Name"] = [[Head]];

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.Head.UIStroke
				HitParts["7"] = Instance.new("UIStroke", HitParts["6"]);
				HitParts["7"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.Head.TextButton
				HitParts["8"] = Instance.new("TextButton", HitParts["6"]);
				HitParts["8"]["BorderSizePixel"] = 0;
				HitParts["8"]["TextTransparency"] = 1;
				HitParts["8"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["8"]["TextSize"] = 14;
				HitParts["8"]["FontFace"] = RealFont
				HitParts["8"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["8"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["8"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["8"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.UpperTorso
				HitParts["9"] = Instance.new("Frame", HitParts["5"]);
				HitParts["9"]["BorderSizePixel"] = 0;
				HitParts["9"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["9"]["AnchorPoint"] = Vector2.new(0.5, 0);
				HitParts["9"]["Size"] = UDim2.new(0, 80, 0, 33);
				HitParts["9"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["9"]["Position"] = UDim2.new(0.5, 0, 0, 68);
				HitParts["9"]["ZIndex"] = 5;
				HitParts["9"]["Name"] = [[UpperTorso]];

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.UpperTorso.UIStroke
				HitParts["a"] = Instance.new("UIStroke", HitParts["9"]);
				HitParts["a"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.UpperTorso.TextButton
				HitParts["b"] = Instance.new("TextButton", HitParts["9"]);
				HitParts["b"]["BorderSizePixel"] = 0;
				HitParts["b"]["TextTransparency"] = 1;
				HitParts["b"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["b"]["TextSize"] = 14;
				HitParts["b"]["FontFace"] = RealFont
				HitParts["b"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["b"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["b"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["b"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LeftUpperLeg
				HitParts["c"] = Instance.new("Frame", HitParts["5"]);
				HitParts["c"]["BorderSizePixel"] = 0;
				HitParts["c"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["c"]["AnchorPoint"] = Vector2.new(0.5, 0);
				HitParts["c"]["Size"] = UDim2.new(0, 40, 0, 55);
				HitParts["c"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["c"]["Position"] = UDim2.new(0, 82, 0, 160);
				HitParts["c"]["Name"] = [[LeftUpperLeg]];

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LeftUpperLeg.UIStroke
				HitParts["d"] = Instance.new("UIStroke", HitParts["c"]);
				HitParts["d"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LeftUpperLeg.TextButton
				HitParts["e"] = Instance.new("TextButton", HitParts["c"]);
				HitParts["e"]["BorderSizePixel"] = 0;
				HitParts["e"]["TextTransparency"] = 1;
				HitParts["e"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["e"]["TextSize"] = 14;
				HitParts["e"]["FontFace"] = RealFont
				HitParts["e"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["e"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["e"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["e"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.HumanoidRootPart
				HitParts["f"] = Instance.new("Frame", HitParts["5"]);
				HitParts["f"]["BorderSizePixel"] = 0;
				HitParts["f"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["f"]["AnchorPoint"] = Vector2.new(0.5, 0);
				HitParts["f"]["Size"] = UDim2.new(0, 80, 0, 25);
				HitParts["f"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["f"]["Position"] = UDim2.new(0.5, 0, 0, 101);
				HitParts["f"]["ZIndex"] = 5;
				HitParts["f"]["Name"] = [[HumanoidRootPart]];

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.HumanoidRootPart.UIStroke
				HitParts["10"] = Instance.new("UIStroke", HitParts["f"]);
				HitParts["10"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.HumanoidRootPart.TextButton
				HitParts["11"] = Instance.new("TextButton", HitParts["f"]);
				HitParts["11"]["BorderSizePixel"] = 0;
				HitParts["11"]["TextTransparency"] = 1;
				HitParts["11"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["11"]["TextSize"] = 14;
				HitParts["11"]["FontFace"] = RealFont
				HitParts["11"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["11"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["11"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["11"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LowerTorso
				HitParts["12"] = Instance.new("Frame", HitParts["5"]);
				HitParts["12"]["BorderSizePixel"] = 0;
				HitParts["12"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["12"]["AnchorPoint"] = Vector2.new(0.5, 0);
				HitParts["12"]["Size"] = UDim2.new(0, 80, 0, 33);
				HitParts["12"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["12"]["Position"] = UDim2.new(0.5, 0, 0, 126);
				HitParts["12"]["ZIndex"] = 5;
				HitParts["12"]["Name"] = [[LowerTorso]];

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LowerTorso.UIStroke
				HitParts["13"] = Instance.new("UIStroke", HitParts["12"]);
				HitParts["13"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LowerTorso.TextButton
				HitParts["14"] = Instance.new("TextButton", HitParts["12"]);
				HitParts["14"]["BorderSizePixel"] = 0;
				HitParts["14"]["TextTransparency"] = 1;
				HitParts["14"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["14"]["TextSize"] = 14;
				HitParts["14"]["FontFace"] = RealFont
				HitParts["14"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["14"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["14"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["14"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.RightUpperLeg
				HitParts["15"] = Instance.new("Frame", HitParts["5"]);
				HitParts["15"]["BorderSizePixel"] = 0;
				HitParts["15"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["15"]["AnchorPoint"] = Vector2.new(0.5, 0);
				HitParts["15"]["Size"] = UDim2.new(0, 40, 0, 55);
				HitParts["15"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["15"]["Position"] = UDim2.new(0, 122, 0, 160);
				HitParts["15"]["Name"] = [[RightUpperLeg]];

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.RightUpperLeg.UIStroke
				HitParts["16"] = Instance.new("UIStroke", HitParts["15"]);
				HitParts["16"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.RightUpperLeg.TextButton
				HitParts["17"] = Instance.new("TextButton", HitParts["15"]);
				HitParts["17"]["BorderSizePixel"] = 0;
				HitParts["17"]["TextTransparency"] = 1;
				HitParts["17"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["17"]["TextSize"] = 14;
				HitParts["17"]["FontFace"] = RealFont
				HitParts["17"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["17"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["17"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["17"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.RightUpperArm
				HitParts["18"] = Instance.new("Frame", HitParts["5"]);
				HitParts["18"]["BorderSizePixel"] = 0;
				HitParts["18"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["18"]["Size"] = UDim2.new(0, 40, 0, 30);
				HitParts["18"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["18"]["Position"] = UDim2.new(1, -61, 0, 68);
				HitParts["18"]["Name"] = [[RightUpperArm]];

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.RightUpperArm.UIStroke
				HitParts["19"] = Instance.new("UIStroke", HitParts["18"]);
				HitParts["19"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.RightUpperArm.TextButton
				HitParts["1a"] = Instance.new("TextButton", HitParts["18"]);
				HitParts["1a"]["BorderSizePixel"] = 0;
				HitParts["1a"]["TextTransparency"] = 1;
				HitParts["1a"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["1a"]["TextSize"] = 14;
				HitParts["1a"]["FontFace"] = RealFont
				HitParts["1a"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["1a"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["1a"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["1a"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LeftLowerArm
				HitParts["1b"] = Instance.new("Frame", HitParts["5"]);
				HitParts["1b"]["BorderSizePixel"] = 0;
				HitParts["1b"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["1b"]["Size"] = UDim2.new(0, 40, 0, 45);
				HitParts["1b"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["1b"]["Position"] = UDim2.new(0, 21, 0, 99);
				HitParts["1b"]["Name"] = [[LeftLowerArm]];

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LeftLowerArm.UIStroke
				HitParts["1c"] = Instance.new("UIStroke", HitParts["1b"]);
				HitParts["1c"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LeftLowerArm.TextButton
				HitParts["1d"] = Instance.new("TextButton", HitParts["1b"]);
				HitParts["1d"]["BorderSizePixel"] = 0;
				HitParts["1d"]["TextTransparency"] = 1;
				HitParts["1d"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["1d"]["TextSize"] = 14;
				HitParts["1d"]["FontFace"] = RealFont
				HitParts["1d"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["1d"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["1d"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["1d"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.RightHand
				HitParts["1e"] = Instance.new("Frame", HitParts["5"]);
				HitParts["1e"]["BorderSizePixel"] = 0;
				HitParts["1e"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["1e"]["Size"] = UDim2.new(0, 40, 0, 13);
				HitParts["1e"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["1e"]["Position"] = UDim2.new(1, -61, 0, 144);
				HitParts["1e"]["Name"] = [[RightHand]];

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.RightHand.UIStroke
				HitParts["1f"] = Instance.new("UIStroke", HitParts["1e"]);
				HitParts["1f"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.RightHand.TextButton
				HitParts["20"] = Instance.new("TextButton", HitParts["1e"]);
				HitParts["20"]["BorderSizePixel"] = 0;
				HitParts["20"]["TextTransparency"] = 1;
				HitParts["20"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["20"]["TextSize"] = 14;
				HitParts["20"]["FontFace"] = RealFont
				HitParts["20"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["20"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["20"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["20"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.RightLowerArm
				HitParts["21"] = Instance.new("Frame", HitParts["5"]);
				HitParts["21"]["BorderSizePixel"] = 0;
				HitParts["21"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["21"]["Size"] = UDim2.new(0, 40, 0, 45);
				HitParts["21"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["21"]["Position"] = UDim2.new(1, -61, 0, 99);
				HitParts["21"]["Name"] = [[RightLowerArm]];

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.RightLowerArm.UIStroke
				HitParts["22"] = Instance.new("UIStroke", HitParts["21"]);
				HitParts["22"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.RightLowerArm.TextButton
				HitParts["23"] = Instance.new("TextButton", HitParts["21"]);
				HitParts["23"]["BorderSizePixel"] = 0;
				HitParts["23"]["TextTransparency"] = 1;
				HitParts["23"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["23"]["TextSize"] = 14;
				HitParts["23"]["FontFace"] = RealFont
				HitParts["23"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["23"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["23"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["23"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LeftUpperArm
				HitParts["24"] = Instance.new("Frame", HitParts["5"]);
				HitParts["24"]["BorderSizePixel"] = 0;
				HitParts["24"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["24"]["Size"] = UDim2.new(0, 40, 0, 30);
				HitParts["24"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["24"]["Position"] = UDim2.new(0, 21, 0, 68);
				HitParts["24"]["Name"] = [[LeftUpperArm]];

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LeftUpperArm.UIStroke
				HitParts["25"] = Instance.new("UIStroke", HitParts["24"]);
				HitParts["25"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LeftUpperArm.TextButton
				HitParts["26"] = Instance.new("TextButton", HitParts["24"]);
				HitParts["26"]["BorderSizePixel"] = 0;
				HitParts["26"]["TextTransparency"] = 1;
				HitParts["26"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["26"]["TextSize"] = 14;
				HitParts["26"]["FontFace"] = RealFont
				HitParts["26"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["26"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["26"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["26"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LeftHand
				HitParts["27"] = Instance.new("Frame", HitParts["5"]);
				HitParts["27"]["BorderSizePixel"] = 0;
				HitParts["27"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["27"]["Size"] = UDim2.new(0, 40, 0, 13);
				HitParts["27"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["27"]["Position"] = UDim2.new(0, 21, 0, 144);
				HitParts["27"]["Name"] = [[LeftHand]];

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LeftHand.UIStroke
				HitParts["28"] = Instance.new("UIStroke", HitParts["27"]);
				HitParts["28"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LeftHand.TextButton
				HitParts["29"] = Instance.new("TextButton", HitParts["27"]);
				HitParts["29"]["BorderSizePixel"] = 0;
				HitParts["29"]["TextTransparency"] = 1;
				HitParts["29"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["29"]["TextSize"] = 14;
				HitParts["29"]["FontFace"] = RealFont
				HitParts["29"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["29"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["29"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["29"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LeftLowerLeg
				HitParts["2a"] = Instance.new("Frame", HitParts["5"]);
				HitParts["2a"]["BorderSizePixel"] = 0;
				HitParts["2a"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["2a"]["AnchorPoint"] = Vector2.new(0.5, 0);
				HitParts["2a"]["Size"] = UDim2.new(0, 40, 0, 20);
				HitParts["2a"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["2a"]["Position"] = UDim2.new(0, 82, 0, 215);
				HitParts["2a"]["Name"] = [[LeftLowerLeg]];

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LeftLowerLeg.UIStroke
				HitParts["2b"] = Instance.new("UIStroke", HitParts["2a"]);
				HitParts["2b"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LeftLowerLeg.TextButton
				HitParts["2c"] = Instance.new("TextButton", HitParts["2a"]);
				HitParts["2c"]["BorderSizePixel"] = 0;
				HitParts["2c"]["TextTransparency"] = 1;
				HitParts["2c"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["2c"]["TextSize"] = 14;
				HitParts["2c"]["FontFace"] = RealFont
				HitParts["2c"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["2c"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["2c"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["2c"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LeftFoot
				HitParts["2d"] = Instance.new("Frame", HitParts["5"]);
				HitParts["2d"]["BorderSizePixel"] = 0;
				HitParts["2d"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["2d"]["AnchorPoint"] = Vector2.new(0.5, 0);
				HitParts["2d"]["Size"] = UDim2.new(0, 40, 0, 10);
				HitParts["2d"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["2d"]["Position"] = UDim2.new(0, 82, 0, 235);
				HitParts["2d"]["Name"] = [[LeftFoot]];

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LeftFoot.UIStroke
				HitParts["2e"] = Instance.new("UIStroke", HitParts["2d"]);
				HitParts["2e"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.LeftFoot.TextButton
				HitParts["2f"] = Instance.new("TextButton", HitParts["2d"]);
				HitParts["2f"]["BorderSizePixel"] = 0;
				HitParts["2f"]["TextTransparency"] = 1;
				HitParts["2f"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["2f"]["TextSize"] = 14;
				HitParts["2f"]["FontFace"] = RealFont
				HitParts["2f"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["2f"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["2f"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["2f"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.RightLowerLeg
				HitParts["30"] = Instance.new("Frame", HitParts["5"]);
				HitParts["30"]["BorderSizePixel"] = 0;
				HitParts["30"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["30"]["AnchorPoint"] = Vector2.new(0.5, 0);
				HitParts["30"]["Size"] = UDim2.new(0, 40, 0, 20);
				HitParts["30"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["30"]["Position"] = UDim2.new(0, 122, 0, 215);
				HitParts["30"]["Name"] = [[RightLowerLeg]];

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.RightLowerLeg.UIStroke
				HitParts["31"] = Instance.new("UIStroke", HitParts["30"]);
				HitParts["31"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.RightLowerLeg.TextButton
				HitParts["32"] = Instance.new("TextButton", HitParts["30"]);
				HitParts["32"]["BorderSizePixel"] = 0;
				HitParts["32"]["TextTransparency"] = 1;
				HitParts["32"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["32"]["TextSize"] = 14;
				HitParts["32"]["FontFace"] = RealFont
				HitParts["32"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["32"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["32"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["32"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.RightFoot
				HitParts["33"] = Instance.new("Frame", HitParts["5"]);
				HitParts["33"]["BorderSizePixel"] = 0;
				HitParts["33"]["BackgroundColor3"] = Color3.fromRGB(27, 27, 27);
				HitParts["33"]["AnchorPoint"] = Vector2.new(0.5, 0);
				HitParts["33"]["Size"] = UDim2.new(0, 40, 0, 10);
				HitParts["33"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["33"]["Position"] = UDim2.new(0, 122, 0, 235);
				HitParts["33"]["Name"] = [[RightFoot]];

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.RightFoot.UIStroke
				HitParts["34"] = Instance.new("UIStroke", HitParts["33"]);
				HitParts["34"]["Color"] = Color3.fromRGB(56, 56, 56);

				-- StarterGui.MyLibrary.HitParts.Holder.BodyPartsHolder.RightFoot.TextButton
				HitParts["35"] = Instance.new("TextButton", HitParts["33"]);
				HitParts["35"]["BorderSizePixel"] = 0;
				HitParts["35"]["TextTransparency"] = 1;
				HitParts["35"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["35"]["TextSize"] = 14;
				HitParts["35"]["FontFace"] = RealFont
				HitParts["35"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["35"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["35"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["35"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.DropShadowHolder
				HitParts["36"] = Instance.new("Frame", HitParts["2"]);
				HitParts["36"]["ZIndex"] = 0;
				HitParts["36"]["BorderSizePixel"] = 0;
				HitParts["36"]["BackgroundTransparency"] = 1;
				HitParts["36"]["Size"] = UDim2.new(1, 0, 1, 0);
				HitParts["36"]["BorderColor3"] = Color3.fromRGB(28, 43, 54);
				HitParts["36"]["Name"] = [[DropShadowHolder]];

				-- StarterGui.MyLibrary.HitParts.DropShadowHolder.DropShadow
				HitParts["37"] = Instance.new("ImageLabel", HitParts["36"]);
				HitParts["37"]["ZIndex"] = 0;
				HitParts["37"]["BorderSizePixel"] = 0;
				HitParts["37"]["SliceCenter"] = Rect.new(49, 49, 450, 450);
				HitParts["37"]["ScaleType"] = Enum.ScaleType.Slice;
				HitParts["37"]["ImageColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["37"]["ImageTransparency"] = 0.5;
				HitParts["37"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
				HitParts["37"]["Image"] = [[rbxassetid://6014261993]];
				HitParts["37"]["Size"] = UDim2.new(1, 55, 1, 55);
				HitParts["37"]["BorderColor3"] = Color3.fromRGB(28, 43, 54);
				HitParts["37"]["Name"] = [[DropShadow]];
				HitParts["37"]["BackgroundTransparency"] = 1;
				HitParts["37"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);

				-- StarterGui.MyLibrary.HitParts.TopBar
				HitParts["38"] = Instance.new("Frame", HitParts["2"]);
				HitParts["38"]["ZIndex"] = 2;
				HitParts["38"]["BorderSizePixel"] = 0;
				HitParts["38"]["BackgroundColor3"] = Color3.fromRGB(25, 25, 25);
				HitParts["38"]["Size"] = UDim2.new(1, 0, 0, 25);
				HitParts["38"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["38"]["Position"] = UDim2.new(-5.1747466756069116e-08, 0, 4.09169338411175e-08, 0);
				HitParts["38"]["Name"] = [[TopBar]];

				-- StarterGui.MyLibrary.HitParts.TopBar.TextLabel
				HitParts["39"] = Instance.new("TextLabel", HitParts["38"]);
				HitParts["39"]["BorderSizePixel"] = 0;
				HitParts["39"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["39"]["TextXAlignment"] = Enum.TextXAlignment.Left;
				HitParts["39"]["FontFace"] = RealFont
				HitParts["39"]["TextSize"] = 14;
				HitParts["39"]["TextColor3"] = Color3.fromRGB(216, 216, 216);
				HitParts["39"]["Size"] = UDim2.new(1, 0, 0, 25);
				HitParts["39"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["39"]["Text"] = [[Hit Points]];
				HitParts["39"]["BackgroundTransparency"] = 1;

				-- StarterGui.MyLibrary.HitParts.TopBar.TextLabel.UIPadding
				HitParts["3a"] = Instance.new("UIPadding", HitParts["39"]);
				HitParts["3a"]["PaddingRight"] = UDim.new(0, 25);
				HitParts["3a"]["PaddingBottom"] = UDim.new(0, 2);
				HitParts["3a"]["PaddingLeft"] = UDim.new(0, 8);
			end
			
			for Index, Value in pairs(HitParts["38d"]:GetChildren()) do
				HitParts["2sfds"] = Instance.new("Frame", Value);
				HitParts["2sfds"]["BorderSizePixel"] = 0;
				HitParts["2sfds"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["2sfds"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
				HitParts["2sfds"]["Size"] = UDim2.new(0, 7, 0, 7);
				HitParts["2sfds"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
				HitParts["2sfds"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);
				HitParts["2sfds"]["Name"] = [[Point]];
				
				HitParts["da"] = Instance.new("UICorner", HitParts["2sfds"]);
				HitParts["da"]["CornerRadius"] = UDim.new(50, 0);
				
				HitParts["2sfds"].MouseEnter:Connect(function()
					if GUI["2"]:GetAttribute("CurrentTab") ~= nil and GUI["2"]:GetAttribute("CurrentTab") == HitPartsTab then
						GUI["ggxxgg"].Visible = true
						Library:UpdateToolTip(Value.Name)
				...
				HitParts["2sfds"].MouseLeave:Connect(function()
					if GUI["2"]:GetAttribute("CurrentTab") ~= nil and GUI["2"]:GetAttribute("CurrentTab") == HitPartsTab then
						GUI["ggxxgg"].Visible = false
					end
				end)
			...
			for Index, Value in pairs(HitParts["5"]:GetChildren()) do
				HitParts["2sfds"] = Instance.new("Frame", Value);
				HitParts["2sfds"]["BorderSizePixel"] = 0;
				HitParts["2sfds"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
				HitParts["2sfds"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
			...
			for Index, Value in pairs(HitParts["2"]:GetDescendants()) do
				if Value:IsA("TextButton") then
					local Frame = Value.Parent
					--
					Value.MouseButton1Click:Connect(function()
						if GUI["2"]:GetAttribute("CurrentTab") ~= nil and GUI["2"]:GetAttribute("CurrentTab") == HitPartsTab then
							if Frame.BackgroundColor3 ~= Color3.fromRGB(0, 255, 0) then
								Library:tween(Frame, {BackgroundColor3 = Library.Theme.Accent})
								table.insert(Library.ThemeObjects, Frame)
								...
								Library:tween(Frame, {BackgroundColor3 = Color3.fromRGB(27, 27, 27)})
								table.remove(Library.ThemeObjects, table.find(Library.ThemeObjects, Frame))
			...
			function Library:HitPartType(Type)
				HitParts["5"].Visible = Type == "R15" and true or false
				HitParts["38d"].Visible = Type == "R6" and true or false
				...
				if Type == "R15" then
					for Index, Value in pairs(HitParts["5"]:GetChildren()) do
						if Value.Name == "HumanoidRootPart" or Value.Name == "Head" or Value.Name == "UpperTorso" then
							Library:tween(Value, {BackgroundColor3 = Library.Theme.Accent})
							table.insert(Library.ThemeObjects, Value)
			...
			function HitParts:FadeOut()
				if next(originalTransparencies3) == nil then

					originalTransparencies3[HitParts["2"]] = HitParts["2"].BackgroundTransparency

					for _, UI in pairs(HitParts["2"]:GetDescendants()) do
						if UI:IsA("Frame") then
							originalTransparencies3[UI] = UI.BackgroundTransparency
						elseif UI:IsA("TextLabel") then
							originalTransparencies3[UI] = UI.TextTransparency
						elseif UI:IsA("UIStroke") then
							originalTransparencies3[UI] = UI.Transparency
						elseif UI:IsA("ImageLabel") then
							originalTransparencies3[UI] = UI.ImageTransparency
						elseif UI:IsA("TextBox") then
							originalTransparencies3[UI] = UI.TextTransparency
						elseif UI:IsA("ScrollingFrame") then
							originalTransparencies3[UI] = UI.ScrollBarImageTransparency
						end
					end
				end

				for UI, _ in pairs(originalTransparencies3) do
					if UI:IsA("Frame") then
						tweenService:Create(UI, newInfo(Library.tweenInfoFadeSpeed, Library.tweenInfoEasingStyle, Enum.EasingDirection.Out), {BackgroundTransparency = 1}):Play()
					elseif UI:IsA("TextLabel") or UI:IsA("TextBox") then
						tweenService:Create(UI, newInfo(Library.tweenInfoFadeSpeed, Library.tweenInfoEasingStyle, Enum.EasingDirection.Out), {TextTransparency = 1}):Play()
			...
			function HitParts:FadeIn()
				for UI, oldTransparency in pairs(originalTransparencies3) do
					if UI:IsA("Frame") then
						tweenService:Create(UI, newInfo(Library.tweenInfoFadeSpeed, Library.tweenInfoEasingStyle, Enum.EasingDirection.Out), {BackgroundTransparency = oldTransparency}):Play()
					elseif UI:IsA("TextLabel") or UI:IsA("TextBox") then
						tweenService:Create(UI, newInfo(Library.tweenInfoFadeSpeed, Library.tweenInfoEasingStyle, Enum.EasingDirection.Out), {TextTransparency = oldTransparency}):Play()
		...
		if options.PlayerList == true then
			...
			do -- Render
				...
				PlayerListTab["9"]["FontFace"] = RealFont
				...
				PlayerListTab["11"]["FontFace"] = RealFont
				...
				PlayerListTab["13"]["FontFace"] = RealFont
				...
				PlayerListTab["16"]["FontFace"] = RealFont
				...
				PlayerListTab["18"]["FontFace"] = RealFont
				...
				PlayerListTab["1a"]["FontFace"] = RealFont
				...
				PlayerListTab["35"]["FontFace"] = RealFont
				...
				PlayerListTab["38"]["FontFace"] = RealFont
				...
				PlayerListTab["20"]["FontFace"] = RealFont
				...
				PlayerListTab["7fe"]["FontFace"] = RealFont
			...
			function PlayerListTab:UpdateFlagText(Player, Flag)
				...
				for Index, Value in pairs(PlayerListTab["24"]:GetChildren()) do
					if Value.Name == Player.Name then
						...
						Flags.Text = Flag
						Flags.TextColor3 = Tab:GetColor(Flag)
					end
				end
			end
			...
			function Library:SetPlayerFlag(Player, Flag)
				if Player == nil then return end
				--
				PlayerListTab:UpdateFlagText(Player, Flag)
			end
			...
			function PlayerListTab:AddFlags(options)
				...
				do -- Render
					...
					PlayerListTab["bf"]["FontFace"] = RealFont
					...
					PlayerListTab["5c"]["FontFace"] = RealFont
					...
					PlayerListTab["6b"]["FontFace"] = RealFont
					...
					do -- Render
						...
						Item["bf"].MouseButton1Down:Connect(function()
							if Item.Hover and not isFadedOut then
								...
								PlayerListTab:UpdateFlagText(PlayerListTab.CurrentPlayer["25"], value)
								Flags:Toggle()
			...
			PlayerListTab["37"].InputBegan:Connect(function(input)
				if input.UserInputType == Enum.UserInputType.MouseButton1 and not isFadedOut then
					if PlayerListTab.CurrentPlayer ~= nil then
						...
						Library:Notify(string.format("Successfully teleported to %s at (%s)", PlayerToTeleportTo.Name, tostring(string.format("%.0f, %.0f, %.0f", PlayerToTeleportTo.Character.HumanoidRootPart.Position.X, PlayerToTeleportTo.Character.HumanoidRootPart.Position.Y, PlayerToTeleportTo.Character.HumanoidRootPart.Position.Z))), 2, "Top Left")
					end
				end
			end)
		...
		function Tab:MultiSection(options)
			...
			function Section:Button(options)
				...
				do -- Render
					...
					Button["13"]["FontFace"] = RealFont
					Button["13"]["TextSize"] = 14;
					Button["13"]["TextColor3"] = options.Risky and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(216, 216, 216);
			...
			function Section:Label(options)
				...
				do -- Render
					...
					Label["42"]["FontFace"] = RealFont
					Label["42"]["TextSize"] = 14;
					Label["42"]["TextColor3"] = options.Risky and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(216, 216, 216);
				...
				do -- Methods
					...
					function Label:ColorPicker(options)
						...
						function ColorPicker:Remove()
							for i, v in pairs(ColorPicker) do
								if typeof(v) == "Instance" and v:IsA("GuiObject") then
									v:Destroy()
								end
							end
						...
						do -- Render
							...
							ColorPicker["bfj"]["FontFace"] = RealFont
						...
						do -- Methods
							function ColorPicker:AddFrame()
								...
								do -- Render
									...
									ColorPicker["3a"]["FontFace"] = RealFont
									...
									ColorPicker["3c"]["FontFace"] = RealFont
									...
									ColorPicker["42"]["FontFace"] = RealFont
									...
									ColorPicker["45"]["FontFace"] = RealFont
								...
								do -- Logic
									...
									ColorPicker["3c"].InputBegan:Connect(function(Input, Process)
									...
									ColorPicker["42"].InputBegan:Connect(function(Input, Process)
									...
									ColorPicker["45"].InputBegan:Connect(function(Input, Process)
										if (not Dragging.Gui and not Dragging.True) and (Input.UserInputType == Enum.UserInputType.MouseButton1) and not isFadedOut then
			...
			function Section:Seperator(options)
				...
				function Seperator:Remove()
					for i, v in pairs(Seperator) do
						if typeof(v) == "Instance" and v:IsA("GuiObject") then
							v:Destroy()
						end
					end
			...
			function Section:Toggle(options)
				...
				do -- Render
					...
					Toggle["36"]["FontFace"] = RealFont
					Toggle["36"]["TextSize"] = 14;
					Toggle["36"]["TextColor3"] = options.Risky and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(216, 216, 216);
						...
						do -- Methods
							...
							function ColorPicker:AddFrame()
								...
								do -- Render
									...
									ColorPicker["44"]["Image"] = [[http://www.roblox.com/asset/?id=18276107765]];
									ColorPicker["44"]["Size"] = UDim2.new(1, 0, 1, 0);
									ColorPicker["44"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
									ColorPicker["44"]["Name"] = [[Image]];
									ColorPicker["44"]["BackgroundTransparency"] = 0;
								...
								do -- Methods
									...
									function ColorPicker:Update(color)
			...
			function Section:Slider(options)
				...
				do -- Render
					...
					Slider["18"]["FontFace"] = RealFont
					Slider["18"]["TextSize"] = 14;
					Slider["18"]["TextColor3"] = options.Risky and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(216, 216, 216);
					...
					-- StarterGui.MyLibrary.MainBackground.Navigation.ButtonHolder.Inactive.TextButton
					Slider["bfs"] = Instance.new("TextButton", Slider["19"]);
					Slider["bfs"]["BorderSizePixel"] = 0;
					Slider["bfs"]["TextTransparency"] = 1;
					Slider["bfs"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
					Slider["bfs"]["TextSize"] = 14;
					Slider["bfs"]["FontFace"] = Font.new([[rbxasset://fonts/families/SourceSansPro.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
					Slider["bfs"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
					Slider["bfs"]["Size"] = UDim2.new(1, 0, 1, 0);
					Slider["bfs"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
					Slider["bfs"]["BackgroundTransparency"] = 1;
					
					-- StarterGui.MyLibrary.MainBackground.ContentContainer.Hometab.Left.Section.ContentContainer.Slider.SliderBack
					Slider["s1b"] = Instance.new("Frame", Slider["17"]);
					Slider["s1b"]["BorderSizePixel"] = 0;
					Slider["s1b"]["BackgroundColor3"] = Color3.fromRGB(14, 14, 14);
					Slider["s1b"]["BackgroundTransparency"] = 1;
					Slider["s1b"]["AnchorPoint"] = Vector2.new(0, 1);
					Slider["s1b"]["Size"] = UDim2.new(0, 20, 1, -5);
					Slider["s1b"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
					Slider["s1b"]["Position"] = UDim2.new(1, -20, 1, -7);
					Slider["s1b"]["Name"] = [[SliderBack]];
					Slider["s1b"]["Visible"] = false;
					
					-- StarterGui.MyLibrary.MainBackground.ContentContainer.Hometab.Right.Section.ContentContainer.TextBox.TextBox
					Slider["7fe"] = Instance.new("TextBox", Slider["s1b"]);
					Slider["7fe"]["PlaceholderColor3"] = Color3.fromRGB(141, 141, 141);
					Slider["7fe"]["BorderSizePixel"] = 0;
					Slider["7fe"]["TextSize"] = 14;
					Slider["7fe"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
					Slider["7fe"]["TextColor3"] = Color3.fromRGB(216, 216, 216);
					Slider["7fe"]["TextXAlignment"] = Enum.TextXAlignment.Right;
					Slider["7fe"]["FontFace"] = Font.new([[rbxasset://fonts/families/SourceSansPro.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
				...
				do -- Logic
					...
					Slider["bfs"].MouseButton1Down:Connect(function()
						if LeftControlDown then
							Slider["s1b"].Visible = true
							Slider["7fe"].Text = Slider["19"].Text
							Slider["19"].Visible = false
					...
					Slider["7fe"]:GetPropertyChangedSignal("Text"):Connect(function()
						local inputText = Slider["7fe"].Text

						inputText = inputText:gsub('[^%d%.%-]+', '')

						inputText = inputText:gsub('%.', function(c)
						...
						Slider["7fe"].Text = inputText
					end)

					Slider["7fe"].FocusLost:Connect(function(EnterPressed)
			...
			function Section:TextBox(options)
				...
				do -- Render
					...
					TextBox["7e"]["TextColor3"] = options.Risky and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(216, 216, 216);
					TextBox["7e"]["FontFace"] = RealFont
			...
			function Section:Dropdown(options)
				...
				do -- Render
					...
					Dropdown["bf"]["FontFace"] = RealFont
					Dropdown["bf"]["TextSize"] = 14;
					Dropdown["bf"]["TextColor3"] = options.Risky and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(216, 216, 216);
			...
			function Section:MultiBox(options)
				...
				do -- Render
					...
					MultiBox["bf"]["FontFace"] = RealFont
					MultiBox["bf"]["TextSize"] = 14;
					MultiBox["bf"]["TextColor3"] = options.Risky and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(216, 216, 216);
	...
	function Library:Init()
		...
		task.delay(0.05, function()
			gui.Size = UDim2.new(gui.Size.X.Scale, gui.Size.X.Offset + 1, gui.Size.Y.Scale, gui.Size.Y.Offset + 1)
		end)
...
local function UpdateNotificationPositions(Position)
	...
	for index, notification in ipairs(notifications) do
		...
		local newPosition = Position == "Middle" and UDim2.new(0, viewport.X / 2 - (notification.Text.TextBounds.X + 4) / 2, 1, -150 - (index * 30)) or UDim2.new(0, 10, 0, 80 + (newIndex * 30))
...
function Library:Notify(Content, Delay, Position)
	...
	do -- Render
		...
		Notification["7"]["FontFace"] = RealFont
		...
		Notification["2"]["Position"] = Position == "Middle" and UDim2.new(0, (viewport.X / 2 - (Notification["7"].TextBounds.X + 4) / 2) - 50, 1, -150) or UDim2.new(0, -50, 0, 80 + (Count * 30))
